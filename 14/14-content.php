<div class="type-14">
    ...
    <div class="img">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="container1">
                    <img src="../14/images/img1.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
            ...
            <div class="col-md-4">
                <div class="container1">
                    <img src="../14/images/img12.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
                            <i class="fa fa-heart-o tzicon"></i>
            ...
            <div class="col-md-4">
                <div class="container1">
                    <img src="../14/images/img3.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
                            <i class="fa fa-heart-o tzicon"></i>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
               <div class="container1">
                    <img src="../14/images/img4.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
                            <i class="fa fa-heart-o tzicon"></i>
            ...
            <div class="col-md-4">
                <div class="container1">
                    <img src="../14/images/img5.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
                            <i class="fa fa-heart-o tzicon"></i>
            ...
            <div class="col-md-4">
                <div class="container1">
                    <img src="../14/images/img7.jpg" alt="">
                    <div class="overlay">
                        <div class="note1">
                            <i class="fa fa-heart-o tzicon"></i>
